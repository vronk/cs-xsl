...
<xsl:value-of select="sru:extraResponseData/fcs:duration"/>
    ...
    <xd:doc>
        <xd:desc>Return a uri that can be used to get a specific record directly <xd:p>This is code
                shared by two template hence this auxilliary template.</xd:p>
        </xd:desc>
        <xd:param name="absolute_position">Position in of the record in the resultset. May be used
            to generate the URI if there is no better way.</xd:param>
    </xd:doc>
...
<xsl:apply-templates select="*" mode="record-data"/>
    ...
    <xd:doc>
        <xd:desc>Transforms one sru:record into two rows in a table <xd:p>The first row contains the
                position of the record in the result as well as a tite generated by the getTitle
                template.</xd:p>
...
<xsl:call-template name="getContext"/>-->
        ...
        <tr
            class="data-view {translate(sru:recordData/fcs:Resource/fcs:DataView/@type, '/+', '__')}">
            <xsl:call-template name="result-rows"/>
        </tr>
    </xsl:template>

    <xd:doc>
        <xd:desc>Returns the total number of columns in a result row, needed for the spacing
            row</xd:desc>
    </xd:doc>
    ...
    <xd:doc>
        <xd:desc>Transforms one sru:record into a definition list item <xd:p>The definition term
                contains the position of the record in the result as well as a tite generated by the
                getTitle template.</xd:p>
